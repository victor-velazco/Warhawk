<?php
	...
	$finalName = "../uploads/AlumniData20160731002141.csv";
    ...
    // Insert data into DB
        ...
        //print_r($all_file);
        echo "<BR/>Univerisites Array:";
        print_r($universities_array);
        echo "<BR/>Genders:";
        print_r($genders_to_insert);
        echo "<BR/>Statuses:";
        print_r($statuses_to_insert);
        echo "<BR/>Countries:";
        print_r($countries_to_insert);
        echo "<BR/>Cities:";
        print_r($cities_to_insert);
        echo "<BR/>Occupations:";
        print_r($occupations_to_insert);
        echo "<BR/>Companies:";
        print_r($companies_to_insert);
        echo "<BR/>Ed. Levels:";
        print_r($education_levels_to_insert);
