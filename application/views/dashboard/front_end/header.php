...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <link href='https://fonts.googleapis.com/css?family=Oswald:100,200,300,400' rel='stylesheet' type='text/css'>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    ?>
                    <li><a href="<?= base_url() ?>index.php/Welcome/about/<?=$this->session->userdata('data')['person_id']?>"><i class="fa fa-user fa-fw"></i> User Profile</a>
                    </li>
                    <?php
                        }
                    ?>
