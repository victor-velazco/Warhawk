...
?>
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="carousel-caption">
                    ...
                    First University Update Headline                    
                    </h2>                    
                    <p class="text-justify raleway">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec tristique malesuada diam. Vivamus mattis purus nec laoreet mattis.</p>
                    <p class="text-justify raleway">Maecenas bibendum mauris tellus, in fringilla massa mattis vitae. Integer tincidunt ante arcu, ut fermentum enim blandit. </p>
                </div>                
		...
		<div class="col-md-3 panel-c8c8c8 text-center panel-body">
                    ...
                    <div class="div-scroller">
                        <table class="table-responsive table-user">
                            <tr class="td-line">
                                <td style="width: 60px;"><img src="<?= base_url() ?>assets/img/foto1.jpg"></td>
                                <td class="text-left">
                                    <h4 class="oswald"><strong>Jane Smith</strong></h4>
                                    <p class="raleway">Updated her current Job.</p>
                                </td>
                            </tr>
                            <tr class="td-line">
                                <td style="width: 60px;"><img src="<?= base_url() ?>assets/img/foto1.jpg"></td>
		...
		<div class="col-md-3">
                    ...
                    <div class="row">
                        <table class="table-responsive" style="white-space: nowrap;">
                            <tr class="padding-0">
                                <td style="width: 90%" class="padding-0"><h4 class="oswald">&nbsp;&nbsp;<strong>Sara Amiri</strong></h4></td>
                                <td class="padding-0">
                                    <a class="btn btn-user" href="path/to/settings">
                                      <i class="fa fa-user fa-inverse" aria-hidden="true"></i>
                                    </a>
                                    <a class="btn btn-config" href="path/to/settings">
	...
	<div class="row">
            ...
            <div class="aluminis"  class="col-md-11 col-sm-11 col-xs-11">
                <div>
                  <img src="<?= base_url() ?>assets/img/alumini1.jpg" alt=""/>
                </div>
                <div>
                    <img src="<?= base_url() ?>assets/img/alumini2.jpg" alt=""/>
                </div>
                <div>
                    <img src="<?= base_url() ?>assets/img/alumini3.jpg" alt=""/>
                </div>
                <div>
                    <img src="<?= base_url() ?>assets/img/alumini4.jpg" alt=""/>
                </div>
                <div>
                    <img src="<?= base_url() ?>assets/img/alumini5.jpg" alt=""/>
                </div>
                <div>
                  <img src="<?= base_url() ?>assets/img/alumini1.jpg" alt=""/>
                </div>
